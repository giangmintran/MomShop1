...
export class AddNewsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (this.config.data.inputData) {
      ...
      this.postForm = this.fb.group({
        ...
        price: [this.inputData.price, [Validators.required]],
        productType: [this.inputData.productType, [Validators.required]],
    ...
    for (let key in MediaConst.productType) {
      this.types.push({ key: key, value: MediaConst.getProductType(key) });
      console.log(this.types);
    }
    for (let key in MediaConst.productStatus) {
      this.statuses.push({ key: key, value: MediaConst.getProductStatus(key)});
    }
  ...
  onSubmit() {
    if (this.inputData) {
      ...
      this.postForm.value.price = parseFloat(this.postForm.value.price)
      this.postForm.value.productType = parseInt(this.postForm.value.productType)
      this.postForm.value.status = parseInt(this.postForm.value.status)
      console.log(this.postForm.value.price);
